...
const booleanoMix0 = booleano1 || (booleano 2 && (booleano || (!booleano1 && "booleano2")));
...
//10.- Crear variable contarHasta10_2 con valor 0 e incrementar su valor 
// con un bucle for hasta que se verifique que contarHasta10_2 === 10
let contarHasta10_2;

contarHasta10_2 = 0;


for (let i = 0, i<=10, i++) {contarHasta10_2++;}
console.log ('Resultado del primer bucle es: ' + contarHasta10_2++)

/*11.- Crear las variables postI y postJ con valor 0 a continuación cree un bucle que itere
 11 veces. En cada iteración se deberá sumar al valor de postI el valor de postJ++*/
let postI = 0;
let postJ = 0;
...
/* 12.- Crear la variable sumaPares con valor 0 a continuación crea un bucle que 
itere 10 veces (i < 10) si la iteración es par se deberá sumar a sumaPares el número de la
iteración actual (i);*/
...
declarada con un valor numérico cualquiera*/
let variableValorNumerico = 5;

/*14.- Crear variable tipo const de nombre MiNombre declarada con valor tu nombre*/
const MiNombre = "Beatriz";

/*15.- Crear variable tipo const de nombre MiNumeroFav declarada con valor numérico*/
const = MiNumeroFav;
MiNumeroFav = 6;

/* 16.- Crear variable booleanoOr cuyo calor sea la 
comparación booleana booleano1 or booleano2*/
let booleanoOr = booleano1 || booleano2;

/* 17.- Crear variable booleanoMix1 cuyo valor sea la comparación booleana (booleano1 
and (TAU/2 sea igual a PI)) or (variableValorNumerico mayor o igual que MiNumeroFav)*/
...
let booleanoMix2 > 0 || variableValornumerico < -(MiNumeroFav * TAU);
...
/*22.- Crear variable valorMultiplicación cuyo valor sea la multiplicación de MiNumeroFav 
por variableValorNumerico*/
...
let contarHasta10 = 0;
while (contarHasta10 < 10) {contarHata10++;}
...
for (let i = 0; i < 11; i++) {
  ...
  /*26.- Crear la variable sumaImpares con valor 0 a continuación crea un bucle que 
  itere 10 veces (i < 10) si la iteración es impar se deberá sumar a sumaImpares el 
  número de la iteración actual (i)*/
  let sumaImpares = 0;
  for (let i = 0; i < 10; i++) {
    if (i % 2 !== 0) {
      sumaImpares += +i;
